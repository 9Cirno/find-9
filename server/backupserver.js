...
const privateKey = fs.readFileSync('/etc/letsencrypt/live/find-9.com/privkey.pem','utf8')
const certificate = fs.readFileSync('/etc/letsencrypt/live/find-9.com/cert.pem','utf8')
const ca = fs.readFileSync('/etc/letsencrypt/live/find-9.com/chain.pem','utf8')
